    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.php?page=london">
              <i class="bi bi-circle"></i><span>London</span>
            </a>
          </li>
          <li>
            <a href="forms-elements.php?page=paris">
              <i class="bi bi-circle"></i><span>Paris</span>
            </a>
          </li>
          <li>
            <a href="forms-elements.php?page=tokyo">
              <i class="bi bi-circle"></i><span>Tokyo</span>
            </a>
          </li>
          <li>
            <a href="forms-layouts.php?page=regis" class="active">
